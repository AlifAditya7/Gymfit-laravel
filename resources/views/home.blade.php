...
<body>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="<?php echo url('gymlife'); ?>/img/classes/class-1.jpg" alt="">
                        </div>
                        <div class="ci-text">
                            <span>STRENGTH</span>
                            <h5>Weightlifting</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="<?php echo url('gymlife'); ?>/img/classes/class-2.jpg" alt="">
                        </div>
                        <div class="ci-text">
                            <span>Cardio</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="<?php echo url('gymlife'); ?>/img/classes/class-3.jpg" alt="">
                        </div>
                        <div class="ci-text">
                            <span>STRENGTH</span>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="<?php echo url('gymlife'); ?>/img/classes/class-4.jpg" alt="">
                        </div>
                        <div class="ci-text">
                            <span>Cardio</span>
                ...
                <div class="col-lg-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="<?php echo url('gymlife'); ?>/img/classes/class-5.jpg" alt="">
                        </div>
                        <div class="ci-text">
                            <span>Training</span>
                            <h4>Boxing</h4>
    ...
    <section class="banner-section set-bg" data-setbg="<?php echo url('gymlife'); ?>/img/banner-bg.jpg">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="ts-slider owl-carousel">
                    <div class="col-lg-4">
                        <div class="ts-item set-bg" data-setbg="<?php echo url('gymlife'); ?>/img/team/team-1.jpg">
                            <div class="ts_text">
                                <h4>Athart Rachel</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="ts-item set-bg" data-setbg="<?php echo url('gymlife'); ?>/img/team/team-2.jpg">
                            <div class="ts_text">
                                <h4>Athart Rachel</h4>
                                <span>Gym Trainer</span>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="ts-item set-bg" data-setbg="<?php echo url('gymlife'); ?>/img/team/team-3.jpg">
                            <div class="ts_text">
                                <h4>Athart Rachel</h4>
                                <span>Gym Trainer</span>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="ts-item set-bg" data-setbg="<?php echo url('gymlife'); ?>/img/team/team-4.jpg">
                            <div class="ts_text">
                                <h4>Athart Rachel</h4>
                                <span>Gym Trainer</span>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="ts-item set-bg" data-setbg="<?php echo url('gymlife'); ?>/img/team/team-5.jpg">
                            <div class="ts_text">
                                <h4>Athart Rachel</h4>
                                <span>Gym Trainer</span>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="ts-item set-bg" data-setbg="<?php echo url('gymlife'); ?>/img/team/team-6.jpg">
                            <div class="ts_text">
                                <h4>Athart Rachel</h4>
                                <span>Gym Trainer</span>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="fs-about">
                        <div class="fa-logo">
                            <a href="#"><img src="<?php echo url('gymlife'); ?>/img/logo.png" alt=""></a>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
